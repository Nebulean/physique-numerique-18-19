...
$\vec{B}(x)$ depends on the horizontal position of the proton, which also oscillate over time according to figure \ref{fig:app2-position}. %TODO: Mettre le graph de la position x en fonction du temps.
