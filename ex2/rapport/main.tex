...
Its norm is equal to $E=\SI{6d4}{\newton\per\coulomb}$ %TODO: Il faut mettre l'unité d'un champ magnétique (j'ai oublié :X)
\begin{figure}[h]
\centering
	\includegraphics[width=0.6\textwidth]{graphs/app1_iii_traj.eps}
	\caption{trajectory of the proton in the moving frame of reference.}
\end{figure}
...
Figure \ref{fig:app2_i_traj} show the trajectories of both particles in the magnetic field B.
