...
\end{subfigure}
	\caption{Vertical velocity $v_y$ of a proton and an antiproton in the magnetic field $\mathbf{B}$ and of a proton in the constant magnetic field $B_0$ (zoomed in on the right-hand side graph)}
