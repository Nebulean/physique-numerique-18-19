...
\begin{subfigure}[c]{0.45\textwidth}
	...
	\label{fig:app1_conv_noEuler}
\end{subfigure}
\end{figure}

In the figure \ref{fig:app1_conv_ALL}, the main information is fact that Euler's method is not appropriate for this simulation.
...
The figure \ref{fig:app1_conv_noEuler} fixes the problem by focusing on the others methods.
