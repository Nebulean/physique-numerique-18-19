...
\section{Implementation}
  ...
  \subsection{Energy of the wave}
    ...
    \section{Tsunami}
      ...
      %TODO : Ajouter une meilleur description de ce qu'on est entrain d'étudier

      %TODO : Mettre la note disant que des points ont été éléminés
      ...
      \lipsum[1-2] %TODO : Discuter le graphe des vitesses de propagations en fct de xa.
      ...
      \lipsum[1-2] %TODO : Discuter le graphe des amplitudes en fct de xa.

      %TODO : Mettre deux graphes d'amplitudes avec le WKB.
      \begin{figure}[h]
        \centering
          ...
          \end{subfigure}
          \caption{Comparison between the WKB analysis ($A_0 \approx \num{16.74}$) and the numerical result for equation B using different $x_a$}
          \label{fig:xa-WKB}
      \end{figure}

      \lipsum[1] %TODO : Discuter les graphes.
