...
for i = 1:nsimul
    ...
    cmd = sprintf('%s%s %s %s=%.15g cb_droit=fixe tfin=14. output=%s', repertoire, executable, input, paramstr, param(i), output{i});
    disp(cmd);
    system(cmd);
end
