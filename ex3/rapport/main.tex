...
On figure \ref{fig:d-comp-theta}, for $\Omega=\SI{18.9091}{\radian\per\s}$ and $\Omega=\SI{20.7091}{\radian\per\s}$, it can be observed a very little respond of the pendulum to the box's excitation, which also means a low maximum mechanical energy for both of them, as seen on figure \ref{fig:d-comp-emec}.
