...
The variation is so small that it could be easily ignored.
...
The mean mechanical energy is then conserved over time.
It implies that, even if the energy is not conserved, the numerical method could still be used, as the error would not explode. %TODO: Remplacer 'explode'
