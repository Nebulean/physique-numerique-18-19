...
\begin{figure}[h]
	...
	\end{subfigure}
	\caption{Comparison of different parameters over time for systems with different $\Omega$ around $\omega0$}
\end{figure}
...
\begin{figure}[h]
	...
	\begin{subfigure}[t]{0.49\textwidth}
		...
		\caption{Zoom on the "jumping" part of \ref{fig:d-emax-full}. \num{101} simulations were done, again, by varying $\Omega\in\left[\num{19.15} - \epsilon, \num{19.15} + \epsilon\right]$, where $\epsilon = \num{1d-2}$.}
		\label{fig:d-emax-close}
	\end{subfigure}
	\caption{Maximum of mechanical energy for a varying $\Omega$. 101 simulations were taken in both cases.}
\end{figure}
