...
The period of the pendulum was measured over $1000$ simulations with $\theta_0 \in ]0,\pi[$, using the Verlet method, and the resulting plot is shown on figure \ref{fig:b-period}, compared to the theoretical solution. As expected, the period grows exponentially with respect to the amplitude.
