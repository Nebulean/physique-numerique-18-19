...
The moment of inertia is the given by $I=mL^2$.\\ %TODO : J'ai pas trouvé de traduction de "point matériel".
...
\subsubsection{Verification of conservation energy theorem}\label{sec:c-thm}
...
\subsubsection{Verification of conservation energy theorem}
The method here is the same described in section \ref{sec:c-thm}.
Thus, the resulting can be seen on figure \ref{fig:d-thm}.
\begin{figure}[h]
\begin{subfigure}[t]{0.52\textwidth}
