...
#c
./Exercice3 configuration.in theta0=0. thetadot0=1e-2 Omega=9.9045444115 d=0.03 kappa=0. tfin=250 output=c_thm.out
#./Exercice3 configuration.in theta0=0. thetadot0=1e-2 Omega=9.9045444115+1 d=0.03 kappa=0. tfin=250 output=c_var.out
