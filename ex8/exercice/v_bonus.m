...
% output = sprintf("v_pot_A");
% output = sprintf("v_pot_Ba");
output = sprintf("v_pot_Bb");
...
% saveas(figProb, sprintf("graphs/%s_prob", output), "epsc");
saveas(figpot, sprintf("graphs/%s_pot", output), "epsc");
