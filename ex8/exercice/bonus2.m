...
cmd = sprintf("./Exercice8 configuration.in output=%s xL=%0.15f xR=%0.15f omega=%0.15f delta=%0.15f x0=%0.15f sigma_norm=%0.15f t_detect=%0.15f n=%0.15f tfin=%0.15f Ninters=%0.15f dt=%0.15f dL=%0.15f dR=%0.15f t_detect2=%0.15f t_detect3=%0.15f t_detect4=%0.15f", output, xL, xR, omega, delta, x0, sigma_norm, tdetect, n, tfin, Ninters, dt, dL, dR, tdetect2, tdetect3, tdetect4);
