...
This behavious does not appear on the border of the heat sources, so it is different from a simple "diffusion", these are singularities. %TODO : C'est pas un peu fort.
