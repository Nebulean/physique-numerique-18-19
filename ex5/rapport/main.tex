...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.55\textwidth]{graphs/c_temp.eps}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.55\textwidth]{graphs/c_heat_flux.eps}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.55\textwidth]{graphs/d_power.eps}
