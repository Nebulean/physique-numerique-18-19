...
Thus, the system tends
 to reach the thermodynamic equilibrum, and heat goes from hot to cold. %TODO : La dernière phrase est pas très belle.
...
\begin{figure}[h]
  ...
  \begin{subfigure}[t]{0.45\textwidth}
    ...
    \caption{Temperature (in degrees Celsius)}%TODO : Y'a une raison pour laquelle t'as mis entre parenthèse ?
    \label{fig:e-T}
  \end{subfigure}
  ~
  \begin{subfigure}[t]{0.45\textwidth}
