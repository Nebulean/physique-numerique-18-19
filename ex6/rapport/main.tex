  ...
  \section{Supplement} %TODO : Le titre de la section pue.
    \subsection{Combination of the trapezoidal rule and the middle point rule} \label{sec:trapezoidal-middle-rule}
      ...
      \centering
       ...
       \caption{Comparison of different functions for $\epsilon_r$}
       \label{eepsr}
      \end{figure}
      ...
      \begin{figure}[h]
        ...
        \caption{Comparison of different function for $\rho_{lib}$. Note that for $r<b$, the default value was not changed.}
        \label{fig:facrho}
      \end{figure}
