...
\section{Finite elements}
  ...
  \subsection{Computation of the polarization charge density $\rho_{pol}$} \label{sec:rhopol}
    ...
    The density of polarization charges can be found using equations \eqref{eq:def-polarization} and \eqref{eq:def-rhopol}, taken from ``The Feynman Lectures on Physics''. \cite{feynman:dielectrics}
