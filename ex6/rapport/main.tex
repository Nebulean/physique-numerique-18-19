...
\section{Differential equation and variational form}
  \subsection{Differential equation for the potential $\phi(\vec{x})$}
...
\section{Finite elements}
  ...
  \begin{figure}[h]
    ...
    \caption{Scheme of the lambda function}
    \label{fig:lambda}
  \end{figure}
  ...
  \subsection{Writing matrix $A$ and vector $\mbf{b}$ of the linear system $A\mbf{\phi}=\mbf{b}$} %TODO : Changer le titre, celui-là pue.
  ...
  On this section, $b=\SI{0.02}{\m}$ and $R=\SI{0.12}{\m}$.

  \paragraph{UN EXEMPLE  DE SOLUTION POUR PHI ET ER}

  \begin{figure}[h]
    \centering
    \begin{subfigure}{0.45\textwidth}
      \includegraphics[width=\textwidth]{graphs/exd1-evoPhi}
      \caption{GRAPHE SOL PHI}
      \label{GRAPHE-SOL-PHI}
    \end{subfigure}
    ~
    \begin{subfigure}{0.45\textwidth}
      \includegraphics[width=\textwidth]{graphs/exd1-evoEr}
      \caption{GRAPHE SOL ER}
      \label{GRAPHE-SOL-ER}
    \end{subfigure}
  \end{figure}

  \paragraph{CONVERGENCE PHI}

  \begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{graphs/exd1-convPhi.eps}
    \caption{blabla convergence of phi AJOUTER UNITES SUR LE GRAPHE}
    \label{tmp-convergence-phi}
  \end{figure}
