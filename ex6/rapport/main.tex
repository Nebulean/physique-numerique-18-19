...
\section{Finite elements}
  ...
  These function are used to approximate $\phi$ and $\eta$.

  \begin{equation}
    \phi\bracket{r}=\Sigma_j\phi_j\Lambda_j\bracket{r}~\text{and}~\eta\bracket{r}=\Sigma_i\eta_i\Lambda_i\bracket{r}
  \end{equation}
