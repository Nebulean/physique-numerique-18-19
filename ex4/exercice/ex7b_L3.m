%% On load les données
cmd = "./Exercice4 configLagrange.in x3=-3.866963974114e8 y3=0 vx3=0 vy3=1029.2336023401617 tFin=63072000"
...
text(x3(1) - 0.3e8, 0.4e8, "L3", 'Color', 'magenta');
...
print(fig, "graphs/ex7b_L3_traj", '-dpng', '-r500');
...
saveas(f2, 'graphs/ex7b_L3_dist','epsc');
