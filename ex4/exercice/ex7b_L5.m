%% On load les données
cmd = "./Exercice4 configLagrange.in x3=197697755.462803 y3=-333201542.055255 vx3=-886.851355174324 vy3=-499.577546276066 tFin=31536000"
% x3=187697755.462803
system(cmd);
d = load("Lagrange.out");
...
text(x3(1) - 0.3e8, 0.4e8, "L5", 'Color', 'magenta');
...
print(fig, "graphs/ex7b_L5_gap_traj", '-dpng', '-r500');
...
saveas(f2, 'graphs/ex7b_L5_gap_dist','epsc');
