...
On constate par ailleurs que le projectile parcourt une distance de \SI{200000}{\kilo\meter} en 24 heures, soit plus de la moitié du trajet total.\\
...
Du travail de réflexion a tout de même été effectué, ce qui amène donc un bref descriptif de la méthode qui aurait été mise en place, si le temps l'avait permis.
\begin{enumerate}
	...
	\item Après avoir drastiquement réduit le champ de recherche des vitesses considérées, refaire un script (shell) qui exécute avec des simulations avec des variations de vitesses plus faibles, ce qui augmente la précision de notre résultat.
...
\appendix
\section*{Annexes}
\addcontentsline{toc}{section}{Annexes}% Ajoute "Annexe" à la table des matières. toc pour table of content, section pour le type, et Annexes pour le titre.
