...
\begin{center}
    \includegraphics[width=0.65\textwidth]{graphs/vB.eps}
    \caption{Vitesse en fonction du temps}
    \label{A-vt}
\end{center}
\end{wrapfigure}
La premier point intéressant est la vitesse du projectile. Le projectile est très fortement ralenti par l'atmosphère, et cela se ressent sur la figure \ref{A-vt}. Dans toutes les simulations, la vitesse suit plus ou moins la même courbe.
